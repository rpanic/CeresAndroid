 ...
 */
package org.rpanic1308.speechactivation;
...
public class SpeechActivatorFactory
{
            ...
            SpeechActivationListener callback, String type)
    {
        ...
        if (type.equals("string.speech_activation_button"))
        {
        ...
        else if (type.equals("string.speech_activation_speak"))
        {
    ...
    public static String getLabel(Context context, SpeechActivator speechActivator)
    {
        ...
        {
            label = "string.speech_activation_button";
        }
        /*else if (speechActivator instanceof WordActivator)
        {
            label = "string.speech_activation_speak";
        }
