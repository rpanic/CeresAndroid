...
public class ExpandableTextView extends TextView
{
    ...
    public ExpandableTextView(final Context context, final AttributeSet attrs, final int defStyle)
    {
        ...
        this.animationDuration = context.getResources().getInteger(R.integer.expand_textView_duration);//DEFAULT_ANIMATION_DURATION;//attributes.getInt(R.styleable.ExpandableTextView_animation_duration, BuildConfig.DEFAULT_ANIMATION_DURATION);
        attributes.recycle();
